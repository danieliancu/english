        ...
        {originalText && (
          <>
            <textarea
              ...
              readOnly
              value={originalText}
              className="mb-2 p-6 border border-gray-300 rounded-lg w-full max-w-xl h-auto"
            />
            <textarea
              value={translatedText}
              onChange={e => setTranslatedText(e.target.value)}
              placeholder="Translate to English..."
              className="mb-2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-full max-w-xl h-24"
              rows="4"
            />
            <button
